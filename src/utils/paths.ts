...
export function getAssetUrl(path: string): void {
...
export function getImageUrl(path: string): void {
    // Remove leading slash to avoid double slashes
    const normalizedPath = path.startsWith('/') ? path.slice(1) : path;
...
export function getPdfUrl(path: string): void {
    // Remove leading slash to avoid double slashes
    const normalizedPath = path.startsWith('/') ? path.slice(1) : path;
...
export function getPublicUrl(path: string): void {
    // Remove leading slash to avoid double slashes
    const normalizedPath = path.startsWith('/') ? path.slice(1) : path;

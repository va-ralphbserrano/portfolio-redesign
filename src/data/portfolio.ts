...
export const portfolioData = {
  title: 'My Portfolio',
  description: 'Explore my recent projects showcasing web development, design, and technical expertise',
  categories: ['all', 'autocad', 'video', 'management', 'design', 'education', 'web', 'demo'],
  projects: [
    {
      id: 1,
...
export type Category = PortfolioData['categories'][number];

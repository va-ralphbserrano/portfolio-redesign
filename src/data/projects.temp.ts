...
export const categories = [
    ...
    ProjectCategory.VIRTUAL_ASSISTANT,
    ProjectCategory.KITCHEN_EQUIPMENT,
    ProjectCategory.INDUSTRIAL_EQUIPMENT,
    ProjectCategory.COMMERCIAL,
    ProjectCategory.CONSTRUCTION,
    ProjectCategory.UTILITIES,
    ProjectCategory.COMPONENTS,
    ProjectCategory.FOOD_SERVICE,
...
export function getProjectsByCategory(category: ProjectCategory): Project[] {
    ...
    if (category === ProjectCategory.ALL) return normalizedProjects;
...
export function getPortfolioProjects(): Project[] {
    return getProjectsByCategory(ProjectCategory.WEB).concat(getProjectsByCategory(ProjectCategory.DESIGN));
}

// Helper function to get technical projects
export function getTechnicalProjects(): Project[] {
    return getProjectsByCategory(ProjectCategory.TECHNICAL);
}

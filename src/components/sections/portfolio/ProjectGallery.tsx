...
export const ProjectGallery: React.FC<ProjectGalleryProps> = ({
  ...
  const categories = useMemo(() => [
    ...
    { id: ProjectCategory.TECHNICAL_DESIGN, label: 'Technical Design' },
    { id: ProjectCategory.WEB_DEVELOPMENT, label: 'Web Development' },
    { id: ProjectCategory.VIRTUAL_ASSISTANT, label: 'Virtual Assistant' },
    { id: ProjectCategory.INDUSTRIAL, label: 'Industrial' },
